...
function drawPyramid() {
    ...
    // use aspect ratio to dynamically calc height
    var graphic_aspect_width = 9;
    var graphic_aspect_height = 5;


    var margin = {top: 20, right: 10, bottom: 10, left: 10};
    var vizWidth = $pyramid.width(),
        w = vizWidth - margin.left - margin.right,
        h = Math.ceil((w * graphic_aspect_height) / graphic_aspect_width) - margin.top - margin.bottom;

    var bins = d3.range(18),
    ...
    rules1 = vis.selectAll("g.rule1")
        ...
        .attr("transform", function(d) {
            return "translate(" + (w/2 + 30 + x1(d)) + ",0)";
        });
